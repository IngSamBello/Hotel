...
const Room = ({ room }) => {
  ...
  return (
    <div className="bg-white  shadow-2xl min-h-[500 px] group">
      {/* {img} */}
      ...
      {/* {details} */}
      <div
        className="bg-white shadow-lg max-w-[300px] mx-auto h-[60px] -translate-y-1/2 flex justify-center items-center uppercase font-tertiary
